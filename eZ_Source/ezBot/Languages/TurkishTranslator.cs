namespace ezBot.Languages
{
    ...
    {
        public string EzBot { get { return "ezBot - LoL için Otomatik Karşılaşma Arayıcı: {0}"; } }
        ...
        public string ErrorJoiningLowPriorityQueue { get { return "Düşük öncelikli sıraya girme sırasında hata oluştu.\Bağlantı kopması."; } }
